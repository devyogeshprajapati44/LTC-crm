...
$fetch   = mysqli_query($conn, "SELECT `msd`.*,`us`.`Id`, `us`.`emp_name`,`us`.`desig_id`,`us`.`father_name`, `us`.`emp_code`,`us`.`permanent_address`, `us`.`joining_date`,`us`.`account_number`, `us`.`bank_name`, `us`.`branch_name`, `us`.`ifsc_code`,`us`.`project_name`, `us`.`aadhar_no`, `us`.`pan_no`, `us`.`uan_no`, `us`.`esi_no`, `us`.`pf_no`,`desig`.`Designation`,`addsal`.`Idd`,`addsal`.`dept_id`,`addsal`.`project_name`,`addsal`.`location`,`addsal`.`account_number`,`addsal`.`bank_name`, `addsal`.`branch_name`, `addsal`.`ifsc_code`, `addsal`.`basic`, `addsal`.`hra_no`, `addsal`.`cca`, `addsal`.`Provident_fund@ 12%`, `addsal`.`advance`, `esi@ 0.75%`, `addsal`.`special_all(SPL)`, `addsal`.`monthly_bonus`, `addsal`.`other_all`, `addsal`.`Professional_tax`, `addsal`.`lwa_amount`, `addsal`.`lop_amounts`, `addsal`.`gross_earning`, `addsal`.`total_deductions`, `addsal`.`salary_in_words`, `addsal`.`net_payble`, `addsal`.`Provident_funds@ 13%`, `addsal`.`working_day`, `addsal`.`esi_@ 3.25%`, `addsal`.`total_days`, `addsal`.`accident_insurance`, `addsal`.`loss_of_pay`, `addsal`.`total_contribution`, `addsal`.`ctc_wages`, `addsal`.`month`, `year`, `addsal`.`amount`, `addsal`.`gross_salary`, `addsal`.`total_payble`, `addsal`.`date_of_salary_transfer`, `addsal`.`salary_release_mode` FROM `employee` `us` LEFT JOIN `designation` `desig` ON `us`.`desig_id`=`desig`.`desig_id` LEFT JOIN `add_salary_slip` `addsal` ON `us`.`Id`=`addsal`.`user_id` LEFT JOIN `master_salary_data` `msd` ON `us`.`Id`=`msd`.`user_id` where `us`.`Id`='$EmpID' AND `month`='$MonthID' AND `year`='$YearID'");
...
if(isset($_POST['update_salary']))
{
   ...
   echo  $update_salary="UPDATE `add_salary_slip` SET 
    ...
    `project_name`='$project_name',
    `location`='$Location',
    `account_number`='$account_number',`bank_name`='$bank_name',`branch_name`='$branch_name',`ifsc_code`='$ifsc_code',`basic`='$basic',`hra_no`='$hra_no',`cca`='$cca',`Provident_fund@ 12%`='$Provident_funt',`advance`='$advance',`esi@ 0.75%`='$esi_amount',`special_all(SPL)`='$special_all',`monthly_bonus`='$monthly_bonus',`other_all`='$other_all',`Professional_tax`='$Professional_tax',`lwa_amount`='$lwa_amount',`lop_amounts`='$lop_amounts',`gross_earning`='$gross_earning',`total_deductions`='$total_deductions',`salary_in_words`='$salary_in_words',`net_payble`='$net_payble',`Provident_funds@ 13%`='$Provident_funds',`working_day`='$working_day',`esi_@ 3.25%`='$esi_amounts',`total_days`='$total_days',`accident_insurance`='$accident_insurance',`leave_taken`='$leave_taken',`loss_of_pay`='$loss_of_pay',`total_contribution`='$total_contribution',`ctc_wages`='$ctc_wages',`amount`='$amount',`gross_salary`='$gross_salary',`total_payble`='$total_payble',`date_of_salary_transfer`='$dateofsalarytrans',`salary_release_mode`='$salary_mode',`UpdatedOn`=now() WHERE `Idd`='$sal_id'";
    //die;
      ...
      <div class="container-fluid px-4">
          <div class="row mt-4">
            <div class="col-md-12">
              ...
              <h1 style="color:#012970;margin-left: -105px;margin-top: 8px;">UPDAT SALARY</h1><br/><br/>
              </nav><br><br>
                <div class="card-body">
          ...
          <!--Bank Details Start-->
                                      ...
                                      <div class="col mt-3">
                                          ...
                                          <div class="row">
                                            <div class="col-3">
                                                ...
                                                <input type="text" class="total_earninig form-control" name="total_earninig" id="total_earninig" value="<?php  echo $rowdata["gross_earning"]; ?>"> <!--Total earning is now gross_earning-->
                                            </div>
        
                                            <div class="col-3">
                                                <label for="text" class="form-label">TOTAL DEDUCATIONS <span style="color: red">*</span></label>
                                                <input type="text" class="total_deductions form-control" name="total_deductions" id="total_deductions" value="<?php  echo $rowdata["total_contribution"]; ?>">
                                            </div>
                                            <div class="col-3">
                                    ...
                                    <div class="col mt-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="leave_taken form-control" name="leave_taken" id="leave_taken" value="<?php  echo $rowdata["leave_taken"]; ?>" >
                                            </div>
                                        </div><br>
                                        <div class="row">
                                            <div class="col-4">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <input type="text" class="ctc_wages form-control" name="ctc_wages" value="<?php  echo $rowdata["total_benefit_monthly"]; ?>" >
                                            </div>
                                        </div><br>
                                        <div class="row">
                                            <div class="col-6">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="gross_salary form-control" name="gross_salary" value="<?php echo $rowdata["gross_pay_monthly"];?>">
                                            </div>
                                            <!-- <div class="col-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <select class="salary_mode form-control" name="salary_mode" id="salary_mode">
                                                 ...
                                                 {
                                                 ?>
                                                 <option value="<?php echo $rowsalary["Salary_mode"];?>" <?php if($rowsalary["Salary_mode"]==$rowdata["salary_release_mode"]) {echo 'selected';}?>><?php echo $rowsalary["Salary_mode"]; ?></option>     
                                            <?php } ?>
                                                 </select>
                                            </div>
                                        </div><br><br>
                      ...
                      <!-- <input type="button" class="btn btn-default" data-bs-dismiss="modal" value="Cancel"> -->
                            <input type="submit" id="update_salary" name="update_salary" class="btn btn-primary add_empolyee" value="Update" style="margin-right: 685px;padding: 12px;width: 123px;">
                          </div>
                         </form>
                       </div>
                      </div>
