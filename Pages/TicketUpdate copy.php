<?php
  ...
  $update_sql="SELECT `ts`.`Id` as `idd`, `ts`.`user_id`, `ts`.`ticket_no`, `ts`.`type_of_ticket`, `ts`.`complain_issue`, `ts`.`status`, `ts`.`ticket_close_date`, `ts`.`CreatedOn`,`emp`.`emp_name` FROM `ticket_system` `ts` LEFT JOIN `employee` `emp` ON `ts`.`user_id`=`emp`.`Id` where `emp`.`Id`='$EmpID'";
  ...
  if(isset($_POST["Updateticket"]))
  {
    ...
    if($run > '0')
    {
      ...
      header("location:PFC.php?PageName=TicketUpdate&Mgs=1");
    }
    else
    {
                      ...
                      <div class="row">
                       ...
                       <div class="col-6">
                            ...
                            <div class="col-6">
                                ...
                                <textarea class="Complain_issue form-control" name="Complain_issue" id="Complain_issue" style="width:384px;height:120px;overflow: auto;" readonly><?php echo $rowData["complain_issue"];?></textarea>
                            </div>
                        ...
                        <div class="col-4">
                                ...
                                <span  class="error">* <?php echo $Err;?></span>
                                <textarea class="admin_remarks form-control" name="admin_remarks" id="admin_remarks" style="width:750px;height:170px;overflow: auto;"></textarea>
                                  </div>
                        </div>
