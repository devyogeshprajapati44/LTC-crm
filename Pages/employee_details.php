              ...
              <div class="card-header"> 
                <div class="card-body">
                    <nav class="navbar navbar-light bg-light">
                      <div class="pagetitle">
                      <center><h1 style="">ADD NEW EMPLOYEE</h1></center>
                    </div>
                   </nav><br><br>
                  <form method="POST">    
                     ...
                     <div class="form-group">
                      ...
                      <div class="row">
                        <div class="col-6">
                          ...
                          <input type="text" class="name form-control" name="empname" placeholder="Enter Employee Name" required>
                        </div>

                        <div class="col-6">
                          <label for="empid" class="form-label">Employee ID</label>
                          <span class="error">* <?php echo $nameErr;?></span>
                          <input type="text" class="empid form-control" name="empid" id="empid" placeholder="Enter Employee ID Name" required>
                        </div>
                       ...
                       <div class="row g-3">
                            <div class="col-4">
                                ...
                                <input type="text" class="email form-control" name="email" placeholder="Enter Email ">
                            </div>
                            <div class="col-4">
                                <label for="text" class="form-label">Phone No</span></label>
                                <span class="error">* <?php echo $phoneErr;?></span>
                                <input type="text"  class="phone form-control"  maxlength="10" name="phone" placeholder="Enter Phone No">
                            </div>
                            <div class="col-4">
                                <label for="text" class="form-label">Alternate Phone No</label>
                                <span class="error">*<?php echo $alternateErr;?></span>
                                <input type="text"  class="alernate_number form-control"  maxlength="10" name="alernate_number" placeholder="Enter Alternate Phone No">
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="col-4">
                           ...
                           <div class="col-4">
                            ...
                            <input type="text" class="father_name form-control" name="father_name" placeholder="Enter Father Name">
                        </div>
                      ...
                      <br>
                        <div class="row">
                         <div class="col">
                            ...
                            <input type="text" class="current_address form-control" name="current_address"  placeholder="Enter Current Address">
                            </div>
                        </div> 
                        <br>
                        <div class="row g-3">
                        ...
                        <div class="row g-3">
                          <div class="col-6">
                            ...
                            <div class="col-6">
                                ...
                                <input type="pin_code"   maxlength="6" class="pin_code form-control" name="pin_code" placeholder="Enter Pincode">
                            </div>
                        </div>
                        <br>                                             
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="permanent_address form-control"  name="permanent_address" placeholder="Enter Permanent Address">
                            </div>
                        </div> 
                    <br>   
                      <div class="row g-3">
                    ...
                    <div class="row g-3">
                     ...
                     <div class="col">  
                       ...
                       <span class="error">*<?php echo $pannoErr;?></span>
                          <input type="text" name="pan_no" class="pan_no  form-control" id="pan_no" placeholder="Enter PAN No">
                     </div>
                  </div> <br>  
                   <div class="row g-3">
                     <div class="col-4">  
                       ...
                       <input type="text" name="uan_no" class="uan_no  form-control" id="uan_no" placeholder="Enter UAN No">
                     </div>

                     <div class="col-4">  
                       <label for="">ESI No</label>
                       <span class="error">*<?php echo $esinoErr;?></span>
                       <input type="text" name="esi_no" class="uan_no  form-control" id="esi_no" placeholder="Enter ESI No">
                     </div>
                     <div class="col-4">  
                       <label for="">PF No</label>
                       <span class="error">*<?php echo $pfnoErr;?></span>
                       <input type="text" name="pf_no" class="pf_no  form-control" id="pf_no" placeholder="Enter PF No">
                     </div>
                   </div> <br> 
                                    ...
                                    <div class="col mt-3">
                                        ...
                                        <div class="row g-3">
                                            <div class=" col-4 ">
                                                ...
                                                <input type="text" class="bank_name form-control" name="bank_name" placeholder="Enter Bank Name">
                                            </div>
                                            <div class=" col-4 ">
                                  ...
                                  <div class="col-sm-10">
                                    ...
                                    <!--password start here-->
                                          <div class="row mb-3">
                                              ...
                                              <input type="submit" name="saveempdetails" class="btn btn-primary add_empolyee" value="Submit" style="margin-left:0px;padding:10px;text-align: center;width:114px"> 
                                            </div>
                                           </div>
                                         </div>
                                       </div>
