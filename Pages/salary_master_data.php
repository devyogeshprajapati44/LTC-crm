             ...
             <div class="row mt-4">
              <div class="col-md-12">
                ...
                <form action="#" method="GET">
                  <a class="btn btn-warning text-black" href="PFC.php?PageName=master_view_salary" style="font-size:large;height:39px;padding:6px;width:100px;margin-left:7px;" role="button">Back</a>
                </form>
                <h1 style="color: #012970;margin-left:481px;margin-top:-40px;">VIEW EMPLOYEE DETAILS</h1>
                 </nav> 
                ...
                <div class="form-group">
                      <fieldset class="scheduler-border">
                        <Form action="" method="POST"><br> 
                                    ...
                                    <tbody>
                                              ...
                                              <td scope="row">
                                                <div class="col-4">
                                                  ...
                                                  <td><input type="text" class="basic_monthly form-control" name="basic_monthly" id="basic_plus" onblur="addsalary()"  placeholder="Enter basic" ></td>
                         ...
                         <input type="submit" name="Addsalary" class="btn btn-primary add_salary" value="Submit" style="margin-right: 462px; font-size: large;height: 42px;padding: 7px;width: 102px;float: left;margin-left: 20px;"> 
                       </div> 
                    </form>          
                  </div>
                </div>
