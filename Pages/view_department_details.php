        ...
        <div class="container py-5">
            <div class="card mt-3">
                ...
                <nav class="navbar navbar-light bg-light">
                   <form method="POST">
                      <input type="text" name="searchvalue" style="margin-left: 13px;height:39px;padding:6px;width:300px;margin-top: 5px;"  placeholder="Enter Department" value="">
                      <input class="btn btn-outline-success my-2 my-sm-0" style="height: 38px;padding: 1px;width: 97px;" type="submit" name="submitsearch" value="Search">
                      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal" style="margin-left: 763px;margin-top: -69px;">+ Add Department</button>
                      <h2 style="color:#012970;margin-left:475px;margin-top:-52px;"><b>ADD DEPARTMENT</b></h2>
                    </form>
              </nav><br><br><br>
          </div>    
         <!--table start-->
  ...
  <div class="modal-dialog modal-lg">
    ...
    <Form  action="#"  method="POST" >
        <div class="modal-header">
              <legend class="card-title"  id="myModalLabel" style="color:#012970;">Add Department</legend>
...
<div id="EditModal" class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="EditModal" aria-hidden="true">
  <div class="modal-dialog modal-lg">
     ...
     <Form action="" method="POST"  id="editForm">
        ...
        <div class="modal-header">
              <legend class="card-title"  id="myModalLabel" style="color:#012970;">Edit Department Details</legend>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
            <div class="modal-body">
                <div class="form-group">
