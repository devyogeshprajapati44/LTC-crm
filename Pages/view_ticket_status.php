          ...
          <div class="row mt-4">
            <div class="col-md-12">
              ...
              <a class="btn btn-warning text-black" href="PFC.php?PageName=view_ticket_list" style="margin:7px;font-size:large;height:37px;padding:6px;width:100px;float:right;" role="button">Back</a>
                 <h1 style="color:#012970;margin-right:12px;">VIEW TICKETS</h1>
                </nav><br><br>
                <div class="card-body">
                      ...
                      <div class="row">
                       ...
                       <div class="col-6">
                        ...
                        <div class="col-4">
                                ...
                                <span  class="error">* <?php echo $Err;?></span>
                                <textarea class="admin_remarks form-control" name="admin_remarks" id="admin_remarks" style="width:650px;height:170px;overflow: auto;" readonly><?php echo $rowData["admin_remarks"];?></textarea>
                                  </div>
                        </div>
