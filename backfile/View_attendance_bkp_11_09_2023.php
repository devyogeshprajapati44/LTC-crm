    ...
    <div class="row column_title">
     <div class="col-md-12">
        <div class="page_title">
            ...
            <a href="PFC.php?PageName=attence_emp"><button type="submit" name="exportCSV" id="exportCSV" class="btn btn-success" style="margin-left: 595px;">Back</button></a>
        </div>
     </div>
    </div>
         ...
         <div class="card-body">
            ...
            <thead class="thead-pink">
              <tr>
               ...
               <tbody>
               <?php
                    $sql="SELECT `ea`.*,`us`.`emp_name` FROM `employee_attendence` `ea` left join `employee` `us` ON `ea`.`user_id`=`us`.`Id` where `ea`.`user_id`='$EmpID' LIMIT $offset, $no_of_records_per_page";
