...
<?php
 ...
 $sql_insert="INSERT INTO `add_salary_slip`(`user_id`, `desig_id`, `dept_id`, `project_name`, `location`, `account_number`, `bank_name`, `branch_name`, `ifsc_code`, `basic`, `hra_no`, `cca`, `Provident_fund@ 12%`, `advance`, `esi@ 0.75%`, `special_all(SPL)`, `monthly_bonus`, `other_all`, `Professional_tax`, `lwa_amount`, `lop_amounts`, `total_earninig`, `total_deductions`, `salary_in_words`, `net_payble`, `Provident_funds@ 13%`, `working_day`, `esi_@ 3.25%`, `total_days`, `accident_insurance`, `leave_taken`, `loss_of_pay`, `total_contribution`, `ctc_wages`, `month`, `year`, `amount`, `gross_salary`, `total_payble`, `date_of_salary_transfer`, `salary_release_mode`,`overtime`) 
 VALUES ('$emp_name',
 '$desig_id',
 '$depart_id',
 '$project_name',
  ...
  <div class="modal-dialog modal-xl">
    ...
    <Form  method="POST" >
        <div class="modal-header">
              <legend class="card-title"  id="myModalLabel"><u>Add Salary :-</u></legend>
        ...
        <div class="modal-body">
                          ...
                          <div class="row">
                                      ...
                                      <div class="col-4">
                                                ...
                                                <input type="text" class="total_days form-control" name="total_days" id="total_days" onkeyup="count_salary()" required>
                                 ...
                                 <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select name="emp_name"  class="fstdropdown-select form-control emp_name" id="emp_name" data-live-search="true"  data-size="8" tabindex="null" onchange="GetDetail(this.value)">
                                      ...
                                      <div class="col mt-3">
                                          <div class="row">
                                              <div class="col-4">
                                                  ...
                                                  <input type="text" class="basic form-control" name="basic" id="basiss"  placeholder="Enter basic" readonly>
                                              ...
                                              <div class="col-4">
                                                ...
                                                <input type="text" class="cca form-control" name="cca" id="cca" readonly>
                                            </div>
                                          </div><br>
                                          <div class="row">
                                              <div class="col-4">
                                              ...
                                              <div class="col-4">
                                                  ...
                                                  <input type="text" class="advance form-control" name="advance" id="advance" readonly>
                                              </div>
                                          </div><br>
                                          <div class="row">
                                            <div class="col-4">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <input type="text" class="monthly_bonus form-control" name="monthly_bonus" id="monthly_bonus" readonly>
                                            </div>
                                            <div class="col-4">
                                          ...
                                          <div class="row">
                                              <div class="col-4">
                                                  ...
                                                  <input type="text" class="Professional_tax form-control" name="Professional_tax" id="Professional_tax"  readonly>
                                              </div>
          
                                              <div class="col-4">
                                                  <label for="text" class="form-label">LWF <span style="color: red">*</span></label>
                                                  <input type="text" class="lwa_amount form-control" name="lwa_amount" id="lwa_amount" value="0" readonly>
                                              </div>
          
                                              <div class="col-4">
                                                  <label for="text" class="form-label">LOP <span style="color: red">*</span></label>
                                                  <input type="text" class="lop_amounts form-control" name="lop_amounts" id="lop_amounts"  value="0" readonly>
                                              </div>
                                          </div><br>
                                          <div class="row">
                                            <div class="col-3">
                                                <label for="text" class="form-label">TOTAL EARNINGS<span style="color: red">*</span></label>
                                                <input type="text" class="total_earninig form-control" name="total_earninig" id="total_earninig" >
                                            </div>
        
                                            <div class="col-3">
                                                <label for="text" class="form-label">TOTAL DEDUCATIONS <span style="color: red">*</span></label>
                                                <input type="text" class="total_deductions form-control" name="total_deductions" id="total_deductions">
                                            </div>
        
                                            <div class="col-3">
                                                <label for="text" class="form-label">Salary in words<span style="color: red">*</span></label>
                                                <input type="text" class="salary_in_words form-control" name="salary_in_words"  id="salary_in_words" >
                                            </div>
                                            <div class="col-3">
                                                <label for="text" class="form-label">NET PAYABLE <span style="color: red">*</span></label>
                                                <input type="text" class="net_payble form-control" name="net_payble"  id="net_payble" >
                                            </div>
                                        </div>
                                      </div>
                                    ...
                                    <div class="col mt-3">
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                              ...
                                              <input type="text" class="working_day form-control" name="working_day" id="working_day" readonly>
                                          </div>
                                        </div>
                                        <br>
                                        <div class="row">
                                            <div class="col-4">
                                                ...
                                                <input type="text" class="accident_insurance form-control" name="accident_insurance" id="accident_insurance" readonly>
                                            </div>
                                            <div class="col-4">
                                                <label for="text" class="form-label">Leave Taken <span style="color: red">*</span></label>
                                                <input type="text" class="leave_taken form-control" name="leave_taken" id="leave_taken" readonly>
                                            </div>
                                            <div class="col-4">
                                                <label for="text" class="form-label">Loss of Pay <span style="color: red">*</span></label>
                                                <input type="text" class="loss_of_pay form-control" name="loss_of_pay" value="0" readonly>
                                            </div>
                                        </div><br>
                                        <div class="row">
                                            <div class="col-4">
                                                <label for="text" class="form-label">TOTAL CONTRIBUTION <span style="color: red">*</span></label>
                                                <input type="text" class="total_contribution form-control" name="total_contribution" id="total_contribution">
                                            </div>
                                            <div class="col-4">
                                                <label for="text" class="form-label">MONTHLY CTC <span style="color: red">*</span></label>
                                                <input type="text" class="monthly_ctc form-control" name="monthly_ctc" id="monthly_ctc">
                                            </div>
                                            <div class="col-4">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="gross_salary form-control" name="gross_salary" id="gross_salary">
                                            </div>
                                            <div class="col-6">
      ...
      if (str.length == 0) 
      {
          ...
          xmlhttp.onreadystatechange = function () {
              ...
              {      
                  ...
                  document.getElementById("basiss").value = myObj[16];
...
<script type="text/Javascript">
  function count_salary()
  {
    ...
    var ED_basic=document.getElementById("basiss").value; 
    ...
    if(ECLD_days_payable!='')
    {
      ...
      document.getElementById("basiss").value=document.getElementById("basic1").value;
...
document.getElementById("total_earninig").value=total_pay;
//TOTAL EARNING IS TOTAL PAYABLE.
...
<script>
  function over_time_cal()
  {
    ...
    var overtime_hours=document.getElementById("overtime").value;
    var cal_over_time;  
    var Gross_sal=document.getElementById("gross_salary").value; 
