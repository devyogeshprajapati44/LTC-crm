    ...
    else
    {
      ...
      while(($myData = fgetcsv($handle,1000,',')) !== FALSE)
      {
         ...
         // $year_date=$date_atten.'-'.$dateNumbers;
          ...
          $select="SELECT `Id` FROM `employee` WHERE `emp_name` IN ('$names')";//IN Operator Find List employee name,Id.
          //die();
          ...
          VALUES ('".$emp_user_id."','".$check_intime."','".$check_in_out_date."','".$check_outtime."','".$check_in_out_date."','".$tootltime."','".$Status."','".$upload_type."')";
