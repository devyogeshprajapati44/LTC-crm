...
//Salary Mode
$fetch_salary_mode   = mysqli_query($conn, "SELECT `srm`.`Salary_mode` FROM `add_salary_slip` `addsal` LEFT JOIN `salary_release_mode` `srm` ON `addsal`.`salary_release_mode`=`srm`.`Id` where `addsal`.`user_id`='$EmpID'");
$salary_data = mysqli_fetch_array($fetch_salary_mode);
$salarymode=$salary_data["Salary_mode"];
//Salary Mode
?>
<style>
#outerdiv
...
<div class="row column1">
                ...
                <div id="outerdiv">
                 ...
                 <thead>
                  <tr>
                    ...
                    <th scope="col" colspan="5" class="h-text">Payslip for the Month of <?php echo $first_date = date('F Y',strtotime('first day of this month'));?></th>
                  </tr>
               </thead>
        <tbody>
  ...
  <tbody>
        <tr>
          ...
          <th scope="row" class="mm">Provident Fund</th>
        ...
        <tr>
          <th scope="row" class="mm">TOTAL EARNINGS</th>
          <td class="textt"><?php echo $rowdata["total_earninig"];?></td>
          <th scope="row" class="mm">TOTAL DEDUCTION</th>
          <td class="textt"><?php echo $rowdata["total_deductions"];?></td>
        </tr>
        <tr>
          ...
          <td class="textt"><?php echo $rowdata["net_payble"];?></td>
        </tr>
  </tbody>
</table><br>
<table class="table table-bordered border-dark" id="table3"  border="2" width="100%">
  ...
  <tbody>
        ...
        <tr>
          ...
          <td class="textt"><?php echo $rowdata["ctc_wages"];?></td>
        </tr>
        <tr>
...
<script type="text/Javascript">
  function printDiv(divId) {
    ...
    newWin.document.write('<html><head><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/css/bootstrap.min.css"><style>.table-bordered{border:2px solid black;}th, td {padding:8px;text-align:left;border-bottom:1px solid #ddd;}.mm{width:150px;}.text{text-align:center;}.textt{text-align:right;}.h-text{text-align:center;color:solid black;} #sublogo{font-size:12px;margin-left:127px;margin-top:-43px;} #images{width:120px;height:100px;margin-top:7px;}@page{size: A4;margin:20px;margin-top: 20px;}@media print { html,body { width:1050px;height:2000px;} #outerdiv{width:72%;height:1000px;margin-left:202px;border:2px solid black;}#table1{width:975px;margin-left:24px;}#table2{width:975px;margin-left:24px;}#table3{width:975px;margin-left:24px;}</style></head><body onload="window.print()">' + divToPrint.innerHTML + '</body></html>');
