...
<div class="row column1">
    <div class="col-md-12">
       <div class="white_shd full margin_bottom_30">
          ...
          <div class="row mt-4">
            <div class="col-md-12">
            <div class="card-header" style="margin-right: 71px;"> 
              ...
              <h2 style="color:#012970;margin-left:-105px;margin-top: 8px;"><b>EMPLOYEE PAY SLIP</b></h2><br/><br/>
              </nav><br><br>
                <div class="card-body">
                <div id="outerdiv">
                  <div id="tableContainer" style="border:1px solid black;">
                  <center><h5 class="card-title text-center"><img id="images" src="assets/img/Latech.jpeg" alt="LatechLogo"></h5></center></br>
                  <h5 id="textid"><b><span style="color:#012970;margin-left: 533px;margin-top: -13px">Phone No : +91 9310457976 Email ID: Info@latech-solutions.com</span></b></h5><br>
                  <h5 id="textlid"><b><span style="color:#012970;margin-left: 533px;margin-top: -13px"> Website: www.latech-solutions.com GST NO : 09AAKFL1138N1ZX</span></b></h5><br>


                  <!-- &nbsp;LATECH SOLUTIONS<br/><p id="sublogo">Solutions For Everyone</p> -->
        ...
        <tr>
          <th scope="row" class="mm">Employee Name</th>
        ...
        <tr>
          <th scope="row" class="mm">Father Name</th>
          <td class="text"><?php echo $rowdata["father_name"];?></td>
...
<h5  class="prit_date" style="color:#012970;margin-left:10px"><b> Print Date:- <?php echo "" . date("d/m/Y") . "<br>";?></b></h5><br>
<h5 class="h-text" style="color:#012970;margin-left:-56px"><b>Note: This is System Generated PaySlip,Sign Not Required.</b></h5><br>
...
<script type="text/Javascript">
  function printDiv(divId) {
    ...
    newWin.document.write('<html><head><link rel="stylesheet"href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css"><style>.table-bordered{border:2px solid black;}th, td {padding:8px;text-align:left;border-bottom:1px solid #ddd;}.mm{width:150px;font-size:12px;}.text{text-align:center;font-size: 12px;}.textt{text-align:right;}.h-text{text-align:center;color:solid black;} #sublogo{font-size:12px;margin-left:127px;margin-top:-43px;} #images{width:120px;height:100px;margin-top:7px;}@page{size: portrait;margin:20px;margin-top: 20px;}@media print { html,body { width:1050px;height:2000px;} #outerdiv{width:100%;height:1000px;margin-left:202px;border:1px solid black;}#textid{margin-left:225px;}#textlid{margin-left:225px;margin-top:-20px;}#table1{width:97%;margin-left:14px;}#table2{width:97%;margin-left:15px;}#table3{width:97%;margin-left:15px;}}</style></head><body onload="window.print()">' + divToPrint.innerHTML + '</body></html>');
