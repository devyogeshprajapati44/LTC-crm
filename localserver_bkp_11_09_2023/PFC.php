...
<head>
    ...
    <link href="vendor/bootstrap/scss/bootstrap.scss" rel="stylesheet" type="text/scss">
...
<div class="d-flex align-items-center justify-content-between">
  ...
  <img src="assets/img/logoo.png" alt="LatechLogo" class="rounded-circle">
    <span class="d-none d-md-block">AdminPanel</span>
  </a>
        ...
        <!----<footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; LaTech Solutions</span>
                </div>
            </div>
        </footer>---->
<?php
