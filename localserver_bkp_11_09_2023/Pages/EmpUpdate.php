          ...
          <div class="row mt-4">
            <div class="col-md-12">
              <div class="card-header"> 
                <div class="card-body">
                 <h5 class="card-title"><u>Update Employee:-</u></h5>
                  <form method="POST">    
                    ...
                    <div class="modal-body">
                     <div class="form-group">
                      ...
                      <div class="row">
                        ...
                        <div class="col-6">
                          <label for="emp_name" class="form-label">Employee ID</label>
                          <span class="error">* <?php echo $nameErr;?></span>
                        ...
                        <div class="row g-3">
                         <div class="col-6 mt-3"> 
                          <label for="country" class="form-label">Country <span class="error">* <?php echo $countryErr;?></span></label><br>
                            ...
                            <?php       
                                  $sqlc = "SELECT * FROM countries WHERE status = 1 and country_id =101  ORDER BY country_id ASC";
                            ...
                            <div class="col-6">
                              ...
                              <span class="error">* <?php echo $stateErr;?></span>
                                ...
                                <?php 
                                    ...
                                    {
                                  ?>
                                  <option value="<?php echo $rowstate["state_id"];?>" <?php if($rowstate["state_id"]==$row["state_id"]){ echo 'selected'; }?>><?php echo $rowstate["state_name"];?></option>              
                               <?php }  ?>
                                </select>
                             </div>
                        </div>
