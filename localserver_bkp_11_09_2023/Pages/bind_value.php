...
$conn = new mysqli("localhost", "u227620396_ltscrm", "LTS_crm0!!", "u227620396_ltscrm");
if ($user_id !== "") 
{      
...
//New added_28-08-2023
    ...
    $dept_id=$row['dept_id'];//department_ID new added
    $total_payable=$row['net_monthly'];//prior name  is Net Monthy  now total payable after substracting deduction.
...
"$total_deduction_b_monthly","$dept_id","$total_payable");//$dept_id new dded
