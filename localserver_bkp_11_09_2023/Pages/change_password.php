    ...
    <div class="col-md-8">
       <div class="white_shd full margin_bottom_30">
         ...
         <form action="#" method="GET">
            <a class="btn btn-info text-black" href="PFC.php?PageName=dashboard" style="margin:-25;font-size:large;height:39px;padding:6px;width:100px;float:right;" role="button">Back</a>
        </form>
           <div class="pagetitle">
