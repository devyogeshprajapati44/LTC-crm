  ...
  <div class="container-fluid">
    <div class="row column_title">
     <div class="col-md-12">
        ...
        <h5 class="card-title"><u>View Roles Details:-</u></h5>
        </div>
     </div>
    </div>
    <!-- row -->
            ...
            <div class="card mt-3">
                <div class="card-header">
                    ...
                    <form action="#" method="POST">
                          <a class="btn btn-warning text-black" href="PFC.php" style="margin:-25;font-size:large;height:39px;padding:6px;width:100px;" role="button">Back</a>&nbsp;&nbsp;
  ...
  <div class="modal-dialog modal-lg">
    ...
    <Form  action=""  method="POST" >
      <div class="modal-header">
          <legend class="card-title"  id="myModalLabel"><u>Add Role Management:-</u></legend>
     ...
     <div class="modal-content">
        <Form action="" method="POST"  id="editForm">
          <input type="hidden" id="roleid" name="roleid"/>
            <div class="modal-header">						
               <h5 class="card-title"><u>Edit Role Details:-</u></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
               <div class="modal-body">			
                   <div class="form-group">     
