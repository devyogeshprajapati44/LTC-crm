                ...
                <tbody>
                  <?php
                     ...
                     ?>
                        ...
                        <td>
                      <form method="POST">
                        <button id="singlebuttonedit" name="empEdit" value="<?php echo $row["Id"]; ?>" class="btn btn-success">Approve</button>
...
<?php
    ...
    if(isset($_POST["empEdit"]))
    {
      $id=$_REQUEST["empEdit"];  
      $EID=EDV($id,1);
      header("location:PFC.php?PageName=TicketUpdate&EmpID=".$EID);
    }
    if(isset($_POST["empview"]))
    {
      $id=$_REQUEST["empview"];  
      $EID=EDV($id,1);
      header("location:PFC.php?PageName=view_ticket_status&EmpID=".$EID);
    }
