          ...
          <div class="row mt-4">
            <div class="col-md-12">
              ...
              <a class="btn btn-warning text-black" href="PFC.php?PageName=view_ticket_list" style="margin:7px;font-size:large;height:37px;padding:6px;width:100px;float:right;" role="button">Back</a>&nbsp;&nbsp;
                <div class="card-body">
                 <h5 class="card-title"><u>View Ticket:-</u></h5>
                  <form method="POST">    
                     ...
                     <div class="form-group">
                      ...
                      <div class="row">
                        ...
                        <div class="col-6">
                          ...
                          <span class="error">* <?php echo $nameErr;?></span>
                          <select  class="form-control" name="typeoftic" id="typeoftic" disabled="true" required>
                       ...
                       <div class="col-6">
                                ...
                                <select  class="form-control" name="status" id="status" disabled="true" required>
                            ...
                            <div class="col-6">
                                ...
                                <textarea class="Complain_issue form-control" name="Complain_issue" id="Complain_issue" style="width:699px;height:120px;overflow: auto;" readonly><?php echo $rowData["complain_issue"];?></textarea>
                            </div>
                        ...
                        <div class="col-4">
                                ...
                                <span  class="error">* <?php echo $Err;?></span>
                                <textarea class="admin_remarks form-control" name="admin_remarks" id="admin_remarks" style="width:1410px;height:170px;overflow: auto;" readonly><?php echo $rowData["admin_remarks"];?></textarea>
                                  </div>
                        </div>
