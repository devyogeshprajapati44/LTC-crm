          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                ...
                <a href="#">
                  <img style="width: 167px;height: 129px;" src="assets/img/latech.jfif" alt="LatechLogo">
                  <!-- <img src="assets/img/logoo.png" alt="LatechLogo" class="rounded-circle" style="width:0px;height:0px;"> -->
