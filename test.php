<html>
  <head>
    ...
    .mm{width:150px;font-size:12px;}
    .text{text-align:center;font-size: 12px;}
    .textt{text-align:right;}
    .h-text{text-align:center;color:solid black;} 
    #sublogo{font-size:12px;margin-left:127px;margin-top:-43px;} 
    #images{width:120px;height:100px;margin-top:7px;}
    @page{size: portrait;margin:20px;margin-top: 20px;}
    @media print { 
      html,body { width:1050px;height:2000px;}
      #textid{margin-right:150px;} 
      #outerdiv{width:100%;height:1000px;margin-left:202px;border:1px solid black;}
      #table1{width:97%;margin-left:14px;}
      #table2{width:97%;margin-left:15px;}
      #table3{width:97%;margin-left:15px;}
    }
      </style>
      </head>
